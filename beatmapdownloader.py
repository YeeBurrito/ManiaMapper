# I used the beatmap downloader from segalll to download all the maps I needed for this project
# Source: https://github.com/segalll/osu-beatmap-downloader
...
def get_desired_mapsets(query: str) -> set[int]:
    ...
    r = api.search_beatmapsets(
        query,
        mode=BeatmapsetSearchMode.MANIA,
